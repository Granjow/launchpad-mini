...
var Color = function ( level, clear, copy, name ) {
    this._level = level;
    this._clear = clear;
    this._copy = copy;
    this._name = name;
...
var
    /** @type {Color} */
    red = new Color( 3, false, false, 'red' ),
    /** @type {Color} */
    green = new Color( 3, false, false, 'green' ),
    /** @type {Color} */
    amber = new Color( 3, false, false, 'amber' ),
    /** @type {Color} */
    yellow = new Color( 3, false, false, 'yellow' ),
    /** @type {Color} */
    off = new Color( 3, false, false, 'off' );
